######################################################################
# Author: Dimitrios Ntentia and Michell Flores-Hernandez
# Username: ntentiad and floreshernandezm
#
...
def pennies_testsuite():
    ...
    mytest(i_steal_pennies(0.9) == [3, 1, 1, 4])
    mytest(i_steal_pennies(1.9)== [11, 1, 1, 4])
    mytest(i_steal_pennies(2.9)== [15, 1, 0, 4])
    mytest(i_steal_pennies(3.9)== [19, 1, 0, 4])
    mytest(i_steal_pennies(4.9)== [23, 1, 0, 4])
    mytest(i_steal_pennies(5.9)== [27, 1, 0, 4])
    mytest(i_steal_pennies(6.9)== [31, 1, 0, 4])
    mytest(i_steal_pennies(7.9)== [35, 1, 0, 4])
    mytest(i_steal_pennies(8.9)== [39, 1, 0, 4])
    mytest(i_steal_pennies(9.9)== [43, 1, 0, 4])
